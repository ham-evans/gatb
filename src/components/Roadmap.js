        ...
        <div className="roadmap">
            ...
            <div className="wrapper">
                ...
                <div className="roadmap__elements">
                    ...
                    <p>Unique drinks ranging from fruity cocktails (shaken, not stirred), beers, spirits and unimaginable beverages are airdropped to lucky Giraffe holders! These drinks may come in handy…</p>
                </div>
                <div className="roadmap__elements">
                    <h2>75% - Pangolins on the Plains!</h2>
                    <p>Giraffe holders will receive a cute pangolin to accompany their Giraffe. The goal is to raise awareness and funds for the struggling pangolin population in Africa and Asia. We will donate a portion of funds directly to Pangolin charities.</p>
                </div>
                <div className="roadmap__elements">
